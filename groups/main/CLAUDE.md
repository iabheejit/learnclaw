...
Main has read-only access to the project and read-write access to the store, global memory, and its group folder:
...
- `/workspace/global/CLAUDE.md` - Shared global memory
